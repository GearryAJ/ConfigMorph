...
class DocumentType(StrEnum):
    CLI_REFERENCE="CLI_REFERENCE"; CONFIGURATION_GUIDE="CONFIGURATION_GUIDE"; ADMIN_GUIDE="ADMIN_GUIDE"; RELEASE_NOTES="RELEASE_NOTES"; COMPATIBILITY_GUIDE="COMPATIBILITY_GUIDE"
